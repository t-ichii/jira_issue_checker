...
type CliOption struct {
	Mode string `short:"m" long:"mode" description:"execute mode (e.g.: rank_checker get_sprint_list)"`
	BoardId int `short:"b" long:"board_id" description:"target board id (use in rank_checker and get_sprint_list mode)"`
